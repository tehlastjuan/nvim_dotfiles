...
local function on_attach(client, bufnr)
    ...
    keymap('<leader>fS', function() require('fzf-lua').lsp_live_workspace_symbols { no_header_i = true } end, 'Workspace symbols')
    ...
    if client:supports_method(methods.textDocument_inlayHint) then
        local inlay_hints_group = vim.api.nvim_create_augroup('tehlastjuan/toggle_inlay_hints', { clear = false })
