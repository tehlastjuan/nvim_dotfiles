...
hl.common = {
  ...
  PmenuSel = {fg = colors.bg, bg = colors.bg_blue},
  ...
  ToolbarButton = {fg = colors.bg, bg = colors.bg_blue},
...
hl.syntax = {
  ...
  Identifier = {fg = colors.red, fmt = cfg.code_style.variables},
  ...
  Todo = {fg = colors.red, fmt = cfg.code_style.comments},
...
hl.treesitter = {
  ...
  ["@character"] = {fg = colors.orange},
  ["@comment"] = {fg = colors.grey, fmt = cfg.code_style.comments},
  ["@comment.todo"] = {fg = colors.red, fmt = cfg.code_style.comments},
  ...
  ["@markup.heading.1.markdown"] = {fg = colors.red, fmt = "bold"},
  ...
  ["@markup.heading.1.marker.markdown"] = {fg = colors.red, fmt = "bold"},
  ...
  ["@variable.builtin"] = {fg = colors.red, fmt = cfg.code_style.variables},
...
hl.plugins.lsp = {
  ...
  DiagnosticVirtualTextHint = {
    ...
    DiagnosticUnderlineError = {fmt = cfg.diagnostics.undercurl and "undercurl" or "underline", sp = colors.red},
  ...
  hl.plugins.nvim_tree = {
    ...
    NvimTreeEndOfBuffer = { fg = cfg.ending_tildes and colors.bg2 or colors.bg_d, bg = cfg.transparent and colors.none or colors.bg_d },
  ...
  hl.plugins.mini = {
    ...
    MiniIconsAzure = { fg = colors.bg_blue },
  ...
  if hl.lsp then vim_highlights(hl.lsp) end
